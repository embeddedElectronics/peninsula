...
The "make_new_cw_project.exe" file can be used to generate a new project. It will make a copy of the hello_world projects using the name specified. Note: it can take a while for the text prompt to come up.
