This project is a simple hello world example. By default the serial port on the tower serial card is used for the terminal output. The terminal should be configured for 115200 8-N-1.
